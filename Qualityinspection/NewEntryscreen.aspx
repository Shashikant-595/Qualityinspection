<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="NewEntryscreen.aspx.cs" Inherits="Qualityinspection.NewEntryscreen" %>
...
<head>
    ...
    <style>
        ...
        .form-container {
            max-height: 500px; /* Set a specific height */
            max-width: 100%;
            overflow-x: auto;
            overflow-y: auto;
            padding: 10px;
...
<body>
    <form id="form1" runat="server">
       ...
       <a href="NewEntryscreen1.aspx" id="employeeli" runat="server">
    ...
    <div class="row">
        ...
        <div class="col-lg-1 col-md-1 col-sm-12">
            <asp:Label ID="Label53" runat="server" Text='Accepted qty' CssClass="label"></asp:Label>
        </div>
        <div class="col-lg-2 col-md-2 col-sm-12 ml-2">
            <asp:TextBox ID="acptqty" runat="server" CssClass="form-control" type="text" onkeypress="return allowOnlyNumbers(event)"></asp:TextBox>
        </div>
        <div class="col-lg-1 col-md-1 col-sm-12">
            <asp:Label ID="lblrej" runat="server" Text='Rejected qty' CssClass="label"></asp:Label>
        </div>
        <div class="col-lg-2 col-md-2 col-sm-12 ml-2">
            <asp:TextBox ID="rejqt" runat="server" CssClass="form-control" type="text" onkeypress="return allowOnlyNumbers(event)"></asp:TextBox>
        </div>
        <div class="col-lg-1 col-md-1 col-sm-12">
            <asp:Label ID="Label52" runat="server" Text='Received qty' CssClass="label"></asp:Label>
        </div>
        <div class="col-lg-2 col-md-2 col-sm-12 ml-2">
            <asp:TextBox ID="resqty" runat="server" CssClass="form-control" type="text" onkeypress="return allowOnlyNumbers(event)"></asp:TextBox>
        </div>
    </div>
</div>

        <div class="form-container  container  label" style="margin-left: 120px;">
            <%--first row--%>
            <div class="row">
                ...
                <itemtemplate>
                    <div class="col-lg-3 col-md-2 col-sm-12">
                        <div class="form-group">
                            ...
                            <asp:TextBox ID="R1" runat="server" CssClass="form-control" type="text" onkeypress="return allowOnlyNumbers(event)"></asp:TextBox>
                        </div>
                    </div>
                </itemtemplate>
                <itemtemplate>
